		<?php
			...
			The connection is created named "Catapult" with a server name "catapult" and database name "catapult" with the credentials as listed in the Pricing Network Data file and "SQL Anywhere 12" as the driver.  Select in "Action:" "Connect to a running database on another computer".  Keep authentication set to "Database" and there's no need to change anything else.  
