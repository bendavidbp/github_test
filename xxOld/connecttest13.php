...
try {
	...
	//$conn = odbc_connect("prototype", "ecrs", "catapult");
	//$conn = odbc_connect("Driver={SQL Server};Server=10.215.76.250,2638;Database=catapult;Trusted_Connection=Yes", "ecrs", "catapult");
