...
<?php
  try {
	...
	//$dbh = new PDO("sqlsrv:server=BRIARPATCH\CSS,2638;Database=catapult;ConnectionPooling=0", "ecrs", "catapult");
	//$dbh = new PDO("sqlsrv:server=BRIARPATCH\CSS,2638;Database=catapult;ConnectionPooling=0", "ecrs", "catapult");
    //$dbh = new PDO("odbc:host=BRIARPATCH\CSS,2638;Database=catapult;ConnectionPooling=0", "ecrs", "catapult");
