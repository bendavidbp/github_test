...
*/
	...
	//$stmt = $conn->prepare("SELECT * FROM InventoryLabelWorksheetData WHERE IWD_ILW_FK = 11941");
	//$stmt = $conn->prepare("SELECT * FROM v_InventoryMaster WHERE CONVERT(VARCHAR(12),INV_SCANCODE) IS LIKE '722252601506'");
	//$stmt = $conn->prepare("SELECT * FROM v_InventoryMaster WHERE inv_pk = 42916");
	//$stmt = $conn->prepare("SELECT * FROM v_InventoryMaster");
	//[inv_scancode] => 722252601506 
